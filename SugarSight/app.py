...
# Header
st.title("🏥 SugarSight")
st.markdown("### Diabetes Risk Assessment Tool")
...
if predict_btn:
    ...
    **⚠️ MEDICAL DISCLAIMER**
    ...
    This prediction tool is for informational purposes only and does not substitute professional medical advice, diagnosis, or treatment. Always seek the advice of your physician or other qualified health provider with any questions you may have regarding a medical condition. Never disregard professional medical advice or delay in seeking it because of something you have read on this application.
    """)
